...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.println(tabela.contem("Morango"));
		System.out.println(tabela.contem("Gato"));
		System.out.println(tabela.contem("Cajá"));
		
		System.out.println(tabela.busca("Faca"));
		System.out.println(tabela.busca("1111"));
